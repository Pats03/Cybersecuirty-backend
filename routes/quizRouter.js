...
const {
  ...
  getScoresByJobRole,
  deleteQuiz,
} = require('../controller/quizController'); // Change from ES module import to CommonJS require
router.get('/quiz/:role', getQuiz);
router.get('/quiz', getAllQuizzes);
router.post('/quiz', createQuiz);
router.put('/quiz/:id', updateQuiz);
router.get('/my-score', getScore);
router.post('/update-score', updateScore);
router.get('/scores-by-jobrole', getScoresByJobRole);
